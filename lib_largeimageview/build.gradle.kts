...
android {
    namespace = "spa.lyh.cn.lib_largeimageview"
    compileSdk = 34
...
centralPortal {
    ...
    pom {
        ...
        url = "https://github.com/liyuhaolol/LargeImageview"
        licenses {
            license {
                name = "The MIT License"
                url = "https://github.com/liyuhaolol/LargeImageview/blob/master/LICENSE"
            }
        }
        developers {
            developer {
        ...
        scm {
            connection = "scm:git@github.com/liyuhaolol/LargeImageview.git"
            developerConnection = "scm:git@github.com/liyuhaolol/LargeImageview.git"
            url = "https://github.com/liyuhaolol/LargeImageview"
        }
